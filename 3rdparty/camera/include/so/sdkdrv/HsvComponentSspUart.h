...
class HsvComponentSspUart : public IHsvComponent {

public:

	HsvComponentSspUart(int device_id);
	virtual ~HsvComponentSspUart();
...
private:
	...
	HsvComponentSsp* m_stream;
	command::CommandUart* m_command;
