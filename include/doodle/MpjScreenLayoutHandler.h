#ifndef LIB_DOODLE_FRAMEWORK_doodle_MpjScreenLayoutHandler_H_
#define LIB_DOODLE_FRAMEWORK_doodle_MpjScreenLayoutHandler_H_
...
class MpjScreenLayoutHandler :
    public MpjScreenLayoutListener,
    public std::enable_shared_from_this<MpjScreenLayoutListener>
{
public:
    /**
...
#endif // LIB_DOODLE_FRAMEWORK_doodle_MpjScreenLayoutHandler_H_
